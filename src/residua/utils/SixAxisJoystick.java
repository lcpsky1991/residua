...
//		p = camera.position() ;
		...
		//rotation.set(theta * 5000, phi * 5000, 0);
		
		//PVector rotated = camera.orientation().rotate(rotation); 
...
//		q.fromAxisAngle(new PVector( rotated.x ,rotated.y ,0),  1);
//		//q.fromAxisAngle(new PVector(0,1,0), rotated_x.y * PApplet.TWO_PI);
